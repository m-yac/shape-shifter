...
export const config = {
  ...
  ui: {
    ...
    helpDialog: {
      ...
      operations: [
        "- Truncate: drag a vertex (corner) inwards to chop it off",
        "- Rectify: drag a vertex all the way",
        "",
        "- Kis: drag the center of a face (flat side) outwards to make it pointy",
        "- Join: drag a face center all the way",
        "",
        "- Snub: hold shift when rectifying",
        "- Gyro: hold shift when kis-ing a face all the way",
        "",
